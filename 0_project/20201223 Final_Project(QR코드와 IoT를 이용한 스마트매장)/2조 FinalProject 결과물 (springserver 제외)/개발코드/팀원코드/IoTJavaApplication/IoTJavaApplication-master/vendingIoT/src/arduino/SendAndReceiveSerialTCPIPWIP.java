...
public class SendAndReceiveSerialTCPIPWIP implements SerialPortEventListener {
	...
	public static void main(String args[]) throws Exception {
		ClientIoT client = new ClientIoT("3.35.11.144", 5555, "[Vending_IoT]");
		SendAndReceiveSerialTCPIPWIP ss = new SendAndReceiveSerialTCPIPWIP("COM3", true, client);
		String cmdPrev = "command";
		//declare command before use
		String cmd = null;
		while (true) {
			Thread.sleep(100);
			// assigne the command. Only from [ADMIN]
			cmd = client.getgMessage();
