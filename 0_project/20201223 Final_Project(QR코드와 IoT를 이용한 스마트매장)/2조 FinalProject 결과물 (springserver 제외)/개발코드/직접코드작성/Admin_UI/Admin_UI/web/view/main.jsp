...
.container { margin: 150px auto; position: relative; max-width: 900px;}
...
<div class="container">
  <section id="content">
    <form action="dashboard.mc">
      <h1>Admin Login</h1>
      <div>
        <input type="text" placeholder="Username" required="" id="username" value = "admin01" />
      </div>
      <div>
        <input type="password" placeholder="Password" required="" id="password" value = "pwd01" />
      </div>
      <div>
